...
# ╔═╡ 9a355872-9984-4a69-9429-7cc8c4a2ac3c
using Catalyst

# ╔═╡ d10ae69e-641b-481a-b371-5439a069ed74
using DifferentialEquations

# ╔═╡ 960cdc10-1b0f-4ed0-8602-d837ba299931
using StochasticDiffEq

# ╔═╡ 831ce362-c513-4f61-895c-8ba415a9e664
using Plots

# ╔═╡ 62e91ce5-800d-4607-97e3-ddf904483c74
...
# ╔═╡ 63f05f17-72ec-4832-b9c9-5f0daa9df833
u0 = [:Z1 => 1.0, :Z2 => 0.0]

# ╔═╡ 036e7306-b8f1-4cc1-8002-b1ff7908e283
tspan = (0.0, 2.0)

# ╔═╡ 4855bc25-eb8f-4ae9-b459-dd0a7f8f2aa8
sprob = SDEProblem(rn, u0, tspan, [])

# ╔═╡ ae12549a-ba1e-4552-a88a-f1a287c270d5
ssol = solve(sprob, LambaEM(), reltol=1e-3)

# ╔═╡ a0851856-40f7-41d1-b91c-96e393ceb1c0
plot(ssol; lw=2)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "cb12d3f2a46268a17adbffe759731874d9a1d7b3"
...
git-tree-sha1 = "d59be3c6fb44949c70207be6418cc84de324a85e"
